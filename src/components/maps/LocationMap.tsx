  ...
  return (
    <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-slate-100 shadow-inner">
          ...
          <div className="mt-2 pt-1.5 border-t border-slate-100 flex items-center justify-between gap-2">
            ...
            {isWithinRadius ? (
              ...
              <span className="inline-flex items-center gap-1 font-bold text-red-700 bg-red-50 px-2 py-0.5 rounded border border-red-200">
                <AlertTriangle size={12} /> {formatDistance(distanceMeters)} (Di Luar Radius)
              </span>
            )}
          </div>
        )}
      ...
      <div className="absolute bottom-3 right-3 z-20 bg-white/90  border border-slate-200 rounded-md px-2.5 py-1 text-[10px] text-slate-600 flex items-center gap-3 shadow-sm">
        ...
        <div className="flex items-center gap-1">
          <span className="w-2.5 h-2.5 rounded-full bg-emerald-600 inline-block" /> Pelaksana (Valid)
        </div>
        <div className="flex items-center gap-1">
          <span className="w-2.5 h-2.5 rounded-full bg-red-500 inline-block" /> Di Luar Radius
        </div>
      </div>
    </div>
  );
