...
-- =======================================================
-- Email: admin.fauzi@fieldwork.id
-- Pass: admin123
-- Hash: $2a$10$f66sYf/gI0z9Z185W68zseR69Z04U/kO5X.jFh2gT1B9e4L0Vl0q6
INSERT INTO users (name, email, nip, password_hash, role, approval_status, is_active)
VALUES (
  'Ahmad Fauzi (Admin)', 
  'admin.fauzi@fieldwork.id', 
  'A001', 
  '$2a$10$f66sYf/gI0z9Z185W68zseR69Z04U/kO5X.jFh2gT1B9e4L0Vl0q6', 
  'ADMIN', 
  'APPROVED', 
  true
